        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0">
                    <i class="fas fa-clipboard-list me-2"></i>Informações do Pedido
                </h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('estimated_amount') is-invalid @enderror" 
                                       name="estimated_amount" id="estimated-amount" value="{{ old('estimated_amount') }}" required readonly>
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('advance_payment') is-invalid @enderror" 
                                       name="advance_payment" id="advance-payment" value="{{ old('advance_payment', 0) }}">
                            </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check mb-3">
                                <input type="checkbox" class="form-check-input" id="create-debt" name="create_debt" value="1"
                                    {{ old('create_debt') ? 'checked' : '' }}>
                                <label class="form-check-label fw-semibold" for="create-debt">
                                    Criar Dívida para o Valor Restante
                                </label>
                            </div>
                            
                            <div id="debt-due-date-container" style="display: {{ old('create_debt') ? 'block' : 'none' }};">
                                ...
                                <input type="date" class="form-control @error('debt_due_date') is-invalid @enderror" 
                                       name="debt_due_date" id="debt-due-date" 
...
<script>
    ...
    function validateForm(e) {
        ...
        // Preparar dados dos itens para envio
        document.getElementById('items-input').value = JSON.stringify(orderItems);
