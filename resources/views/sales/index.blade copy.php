...
@section('content')
    <div class="container-wrapper">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-2 col-lg-2">
                <div class="stat-card action-card h-100 d-flex flex-column justify-content-between">
                    <div class="stat-content">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-select" id="payment_method" name="payment_method">
                                ...
                                <option value="cash" {{ request('payment_method') == 'cash' ? 'selected' : '' }}>
                                    Dinheiro</option>
                                <option value="card" {{ request('payment_method') == 'card' ? 'selected' : '' }}>Cartão
                                </option>
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-select" id="has_discount" name="has_discount">
                                ...
                                <option value="1" {{ request('has_discount') == '1' ? 'selected' : '' }}>Com desconto
                                </option>
                                <option value="0" {{ request('has_discount') == '0' ? 'selected' : '' }}>Sem desconto
                                </option>
                            </select>
                        </div>
